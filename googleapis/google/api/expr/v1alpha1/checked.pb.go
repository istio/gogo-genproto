...
func _Type_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Type_Null:
		...
		_ = b.EncodeVarint(uint64(x.Null))
	case *Type_Primitive:
		_ = b.EncodeVarint(3<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.Primitive))
	case *Type_Wrapper:
		_ = b.EncodeVarint(4<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.Wrapper))
	case *Type_WellKnown:
		_ = b.EncodeVarint(5<<3 | proto.WireVarint)
		_ = b.EncodeVarint(uint64(x.WellKnown))
	case *Type_ListType_:
	...
	case *Type_MessageType:
		...
		_ = b.EncodeStringBytes(x.MessageType)
	case *Type_TypeParam:
		_ = b.EncodeVarint(10<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.TypeParam)
	case *Type_Type:
...
func _Type_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // type_kind.null
		...
		m.TypeKind = &Type_Null{types.NullValue(x)}
		return true, err
